    ...
    while True:
        ...
        while True:
            ...
            if success==True:
                ...
                cv2.rectangle(myimgCopy,(50,50-30),(400,50),color=(255,0,0),thickness=-1)
                cv2.putText(myimgCopy,"Press 'q' to click..!!!",org=(50,50),fontFace=cv2.FONT_HERSHEY_COMPLEX,fontScale=1,color=(255,255,255),thickness=1)
        ...
        try:
            ...
            for trainencode in trainEncodings:
                ...
                if result[0]==True:
                    ...
                    print(f'Face matched with->{classname[count]}..!!!')
                    cv2.rectangle(myimg,(x1,y2),(x2,y2+30),color=(255,0,0),thickness=-1)
                    ...
                    voice_command(f"Face matched with->{classname[count]}","result") #audio
                    cv2.waitKey(0)
                    break
                count=count+1
            else:
        ...
        voice_command("enter 1 to retake pic or 0 to exit","retake")
        print("1 to retake pic 0 to exit")
        choice=int(input())
        if choice==0:
            break
        else:
